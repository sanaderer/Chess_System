...
public class ChessMatch {
    ...
    private ChessPiece newPiece(String type, Color color){
        ...
        return new Queen.Rook(board, color);
    }
    ...
    private void initialSetup(){
        placeNewPiece('a', 1, new Queen.Rook(board, Color.WHITE));
        ...
        placeNewPiece('h', 1, new Queen.Rook(board, Color.WHITE));
        ...
        placeNewPiece('a', 8, new Queen.Rook(board, Color.BLACK));
        ...
        placeNewPiece('h', 8, new Queen.Rook(board, Color.BLACK));
